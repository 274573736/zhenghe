<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:108:"/www/wwwroot/linux.henan863.cn/addons/make_freight/core/public/../application/admin/view/auth/admin/add.html";i:1562722772;s:98:"/www/wwwroot/linux.henan863.cn/addons/make_freight/core/application/admin/view/layout/default.html";i:1562722712;s:95:"/www/wwwroot/linux.henan863.cn/addons/make_freight/core/application/admin/view/common/meta.html";i:1562722738;s:97:"/www/wwwroot/linux.henan863.cn/addons/make_freight/core/application/admin/view/common/script.html";i:1562722738;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="email" class="control-label col-xs-12 col-sm-2">小程序ID:</label>
        <div class="col-xs-12 col-sm-8">
            <input type="number" class="form-control"  name="row[uniacid]" value="" />
        </div>
    </div>
    <div class="form-group">
