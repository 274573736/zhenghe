<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:105:"/www/wwwroot/linux.henan863.cn/addons/make_freight/core/public/../application/admin/view/index/login.html";i:1567949838;s:95:"/www/wwwroot/linux.henan863.cn/addons/make_freight/core/application/admin/view/common/meta.html";i:1562722738;s:97:"/www/wwwroot/linux.henan863.cn/addons/make_freight/core/application/admin/view/common/script.html";i:1562722738;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
                ...
                <div class="login-screen">
                    <div class="well">
                        <div class="login-form">
                            <img id="profile-img" class="profile-img-card" src="/addons/make_freight/core/public/assets/img/avatar.png" />
                            <p id="profile-name" class="profile-name-card"></p>

                            <form action="" method="post" id="login-form">
                                <div id="errtips" class="hide"></div>
                                <div hidden><?php echo token(); ?></div>
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon" style="padding:0;border:none;cursor:pointer;">
                                        <img src="<?php echo rtrim('/addons/make_freight/core/public/', '/'); ?>/index.php?s=/captcha" width="100" height="30" onclick="this.src = '<?php echo rtrim('/addons/make_freight/core/public/', '/'); ?>/index.php?s=/captcha&r=' + Math.random();"/>
                                    </span>
                                </div>
                                <?php endif; ?>
