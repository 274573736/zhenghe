    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                showFooter: true,
                extend: {
                    index_url: 'busines/cashlog/index',
                    add_url: 'busines/cashlog/add',
                    del_url: 'busines/cashlog/del',
                    multi_url: 'busines/cashlog/multi',
                    table: 'user_cashlog'
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'business.name', title: __('Business')},
