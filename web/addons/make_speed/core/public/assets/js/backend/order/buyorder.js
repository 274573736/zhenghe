    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                ...
                extend: {
                    index_url: 'order/buyorder/index',
                    edit_url: 'order/buyorder/edit',
                    detail_url: 'order/buyorder/detail',
                    del_url: 'order/buyorder/del',
                    multi_url: 'order/buyorder/multi',
                    tasking_url: 'order/buyorder/tasking',
                    table: 'buyorder',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'user.nick_name', title: __('User_id'),width:180, operate:'LIKE'},
                        {field: 'goodsname', title: __('Goods_id'), width:130, formatter:Controller.api.formatter.goods, operate:'LIKE'},
                        {field: 'address', title: '购买地点',width:140, formatter:Controller.api.formatter.address, operate:'BETWEEN'},
        ...
        api: {
            formatter:{
                address : function(value,row,index){
                    if(!row.address){
                        return '<span class="text-primary">就近购买</span>';
                    }

                    return '<span>指定地点购买</span>';
                },
