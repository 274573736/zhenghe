    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                ...
                extend: {
                    index_url: 'order/lineorder/index',
                    edit_url: 'order/lineorder/edit',
                    detail_url: 'order/lineorder/detail',
                    del_url: 'order/lineorder/del',
                    multi_url: 'order/lineorder/multi',
                    tasking_url: 'order/lineorder/tasking',
                    table: 'lineorder',
                }
            });
