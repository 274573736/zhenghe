    ...
    var Controller = {
        index: function () {
            ...
            $("form.sidebar-form").on('mousedown click', '.menuresult a[data-url]', function () {
                ...
                var str = '/addons/make_speed/core/public/admin/';

                if(($(this).data("url")).indexOf('index.php') > -1){
                    str = '/addons/make_speed/core/public/index.php/admin/';
                }

                Backend.api.addtabs(($(this).data("url")).substr(str.length));
            });
