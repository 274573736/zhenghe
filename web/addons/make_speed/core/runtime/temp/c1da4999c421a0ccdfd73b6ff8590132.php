<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:106:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/public/../application/admin/view/goodstype/edit.html";i:1586002374;s:96:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/layout/default.html";i:1582941334;s:93:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/common/meta.html";i:1582941334;s:105:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/freight/common/checkBox.html";i:1582941334;s:95:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/common/script.html";i:1582941334;}*/ ?>
<!DOCTYPE html>
...
.bella-checkbox label {
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_select('row[order_type]', $typeList, $row['order_type'], ['class'=>'form-control', 'required'=>'']); ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-icon" class="form-control form-control" size="50" data-rule="required" name="row[icon]" type="text" value="<?php echo $row['icon']; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-iconed" class="form-control form-control" size="50" data-rule="required" name="row[iconed]" type="text" value="<?php echo $row['iconed']; ?>">
                <div class="input-group-addon no-border no-padding">
...
<?php echo base64_decode('5pu05aSa5rqQ56CB6K+36K6/6Zeu6LWE5rqQ6YKm5rqQ56CB572R4oCUd3d3LndhenliLmNvbQ=='); ?>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-weight" data-rule="required" class="form-control form-control" name="row[weight]" type="number" value="<?php echo $row['weight']; ?>">
        </div>
    </div>
