<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:113:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/public/../application/admin/view/general/profile/index.html";i:1582941334;s:96:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/layout/default.html";i:1582941334;s:93:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/common/meta.html";i:1582941334;s:105:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/freight/common/checkBox.html";i:1582941334;s:95:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/common/script.html";i:1582941334;}*/ ?>
<!DOCTYPE html>
                ...
                <form id="update-form" role="form" data-toggle="validator" method="POST" action="general/profile/update">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <div class="profile-avatar-container">
                            <img class="profile-user-img img-responsive img-circle" src="<?php echo $admin['avatar']; ?>" alt="">
                            <!--<div class="profile-avatar-text img-circle"><?php echo __('Click to edit'); ?></div>-->
                            <!--<button id="plupload-avatar" class="" data-input-id="c-avatar"><i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button>-->
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="row[realname]" value="<?php echo $admin['realname']; ?>" disabled/>
                        </div>
                        <div class="form-group">
                            <label for="email" class="control-label">联系电话:</label>
                            <input type="text" class="form-control" name="row[mobile]" value="<?php echo $admin['mobile']; ?>" data-rule="mobile" disabled/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="row[email]" value="<?php echo $admin['email']; ?>" data-rule="email" />
                        </div>
