<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:103:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/public/../application/admin/view/index/login.html";i:1582941334;s:93:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/common/meta.html";i:1582941334;s:95:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/common/script.html";i:1582941334;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
                ...
                <div class="login-screen">
                    <div class="well">
                        <div class="login-form">
                            <img  class="profile-img-card" src="/addons/make_speed/core/public/assets/img/avatar.png" />
                            <p id="profile-name" class="profile-name-card"></p>

                            <form action="" method="post" >
                                <div id="errtips" class="hide" style="opacity:0;">
                                <?php echo token(); ?>
                                </div>
