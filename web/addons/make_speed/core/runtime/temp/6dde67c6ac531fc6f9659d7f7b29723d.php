<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:112:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/public/../application/admin/view/person/usergrade/add.html";i:1582941334;s:96:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/layout/default.html";i:1582941334;s:93:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/common/meta.html";i:1582941334;s:105:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/freight/common/checkBox.html";i:1582941334;s:95:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/common/script.html";i:1582941334;}*/ ?>
<!DOCTYPE html>
...
.bella-checkbox label {
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-grade" data-rule="required" class="form-control form-control" name="row[grade]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Grow'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-grow" data-rule="required" class="form-control form-control" name="row[grow]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <div class="input-group">
                <input id="c-discount" data-rule="required" class="form-control form-control" name="row[discount]" type="text" value="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-icon" class="form-control form-control" size="50" name="row[icon]" type="text" value="">
        ...
        <span class="help-block"><a href="https://www.iconfont.cn/search/index?q=vip&page=1" target="view_window"><i class="fa fa-hand-pointer-o mr-xs"></i>搜索图标</a></span>
    </div>
