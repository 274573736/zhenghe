<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:109:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/public/../application/common/view/tpl/dispatch_jump.tpl";i:1582941334;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="system-message <?php echo $codeText; ?>">
    <div class="image">
        <img src="/addons/make_speed/core/public/assets/img/<?php echo $codeText; ?>.svg" alt="" width="150" />
    </div>
    <h1><?php echo $msg; ?></h1>
    <?php if($url): ?>
        <p class="jump">
