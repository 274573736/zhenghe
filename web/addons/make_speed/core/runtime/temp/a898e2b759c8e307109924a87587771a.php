<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:103:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/public/../application/admin/view/index/index.html";i:1582941334;s:93:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/common/meta.html";i:1582941334;s:95:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/common/header.html";i:1582941334;s:93:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/common/menu.html";i:1582941334;s:96:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/common/control.html";i:1582941334;s:95:"/www/wwwroot/linux.henan863.cn/addons/make_speed/core/application/admin/view/common/script.html";i:1582941334;}*/ ?>
<!DOCTYPE html>
...
<nav class="navbar navbar-static-top">
    ...
    <div id="firstnav">
        ...
        <ul class="nav nav-tabs nav-addtabs  hidden-xs" role="tablist">
            <?php echo $navlist; ?>
        </ul>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <!--<li>-->
                    <!--<a href="/addons/make_speed/core/public/" target="_blank"><i class="fa fa-home" style="font-size:14px;"></i></a>-->
                <!--</li>-->
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <?php else: ?>
                        <img src="/addons/make_speed/core/public/assets/img/avatar.png" class="user-image" alt="">
                        <span class="hidden-xs"><?php echo $admin['nickname']; ?></span>
                        <?php endif; ?>
                    </a>
                    <ul class="dropdown-menu">
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            ...
            <?php else: ?>
            <a href="general/profile" class="addtabsit"><img src="/addons/make_speed/core/public/assets/img/avatar.png" class="img-circle" /></a>
            <?php endif; ?>
        </div>
    ...
    <form action="" method="get" class="sidebar-form" onsubmit="return false;">
        <div class="input-group">
            <input type="text" name="q" class="form-control" autocomplete="off" placeholder="<?php echo __('Search menu'); ?>">
...
<scritp src="/addons/make_speed/core/public//assets/plugins/layer/layer.js"></scritp>
<scritp src="/addons/make_speed/core/public//assets/js/backend.js"></scritp>
<script src="/addons/make_speed/core/public/assets/libs/jquery/dist/jquery.min.js"></script>
...
<!--</script>-->
 ...
 <script>
    var host_ = "<?php echo isset($domain__)?$domain__: ''; ?>";

    var cityid = "<?php echo $cityid; ?>";

    var wsServer = 'wss'+host_+':'+"<?php echo $port; ?>";
    ...
    var BGM_URL =  "/addons/make_speed/core/public/"+"<?php echo $bgm_url; ?>";

    websocket.onopen = function (evt) {
        websocket.send("type=pc_message&uniacid=<?php echo $GLOBALS['uniacid']; ?>");
    ...
    websocket.onerror = function (evt, e) {
        console.log('Error occured: ' + evt.data);
                ...
                <!--<?php if(empty($mcopyright) &&  empty($_w_copyright)): ?>-->
                <!--<div class="container-fluid footer text-center" role="footer" style=" position:absolute;left:10px;bottom:13px;">-->
                    <!--<div class="copyright">-->
                        <!--<span style='color:#fff'>Powered by </span><a href="http://www.we7.cc"><b>微擎</b></a>-->
                        <!--<span style='color:#fff'> v2.0.7</span>-->
                        <!--<span style='color:#fff'>  &copy; 2014-2019 www.w7.cc</span>-->
                    <!--</div>-->
                <!--</div>-->
                <!--<?php endif; ?>-->
            </aside>
