	...
	<div class="panel-body table-responsive js-table">
		<table class="table table-hover">
			...
			<tr>
				...
				<td>yen <?php  echo $order['total_fee'];?></td>
				<td>yen <?php  echo $order['no_discount_part'];?></td>
				<td>yen <?php  echo $order['discount_fee'];?></td>
				<td>yen <?php  echo $order['final_fee'];?></td>
				<td>yen <?php  echo $order['plateform_serve_fee'];?></td>
				<td>yen <?php  echo $order['store_final_fee'];?></td>
			</tr>
			<?php  } } ?>
		</table>
	</div>
