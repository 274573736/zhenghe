...
util.base64Encode = function(e) {
    ...
    var t = wx.getStorageSync("userInfo").sessionid, i = a.url;
    if (-1 == i.indexOf("http://") && -1 == i.indexOf("https://") && (i = util.url(i)), 
    getUrlParam(i, "state") || a.data && a.data.state || !t || (i = i + "&state=we7sid-" + t), 
    !a.data || !a.data.m) {
        var n = getCurrentPages();
        n.length && (n = n[getCurrentPages().length - 1]) && n.__route__ && (i = i + "&m=" + n.__route__.split("/")[0]);
    }
    var s = getSign(i, a.data);
    if (s && (i = i + "&sign=" + s), !i) return !1;
    if (a.showLoading && util.showLoading(), a.cachetime) {
        var o = e(i), u = wx.getStorageSync(o), c = Date.parse(new Date());
        if (u && u.data) {
            if (u.expire > c) return a.complete && "function" == typeof a.complete && a.complete(u), 
            a.success && "function" == typeof a.success && a.success(u), console.log("cache:" + i), 
            !0;
