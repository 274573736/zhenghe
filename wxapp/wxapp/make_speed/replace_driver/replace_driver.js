...
Page({
    ...
    onLoad: function(e) {
        var t = this;
        wx.removeStorageSync("coupons"), app.getAppSetting(3), this.getIsNewCoupons(), app.connectWs(), 
        homeModule.driverType().then(function(e) {
            t.setData({
                type: e.type
            });
        }, function(e) {});
    ...
    confirm: function(e) {
        ...
        if (!n.person_tel) return app.hint("请选择出发地~");
        ...
        settingModule.auth(0).then(function(e) {
            if (e) {
                ...
                if ("function" == typeof wx.requestSubscribeMessage) {
                    ...
                    return void wx.requestSubscribeMessage({
                        ...
                        complete: function(e) {
                            a.setData({
                                loading: !0
                            }), homeModule.toOrder(c).then(function(e) {
                                if (2 == a.data.type) return app.closeWs(), app.hint("下单成功~", "success"), void setTimeout(function() {
                                    wx.redirectTo({
                                        url: "../order_pay/order_pay?order_id=" + e.order_id + "&status=2"
                                    });
                                }, 400);
                                a.pay(e.order_id, o), wx.removeStorageSync("coupons");
                            }, function(e) {
                                a.setData({
                                    loading: !1
                                });
                ...
                return a.setData({
                    loading: !0
                }), void homeModule.toOrder(c).then(function(e) {
                    if (2 == a.data.type) return app.closeWs(), app.hint("下单成功~", "success"), void setTimeout(function() {
                        wx.redirectTo({
                            url: "../order_pay/order_pay?order_id=" + e.order_id + "&status=2"
                        });
    ...
    paySuccess: function(e, t) {
        ...
        setTimeout(function() {
            wx.redirectTo({
                url: "../order_pay/order_pay?order_id=" + e + "&status=2"
            });
        }, 400);
    },
    failPay: function(e) {
        wx.redirectTo({
            url: "../order_pay/order_pay?order_id=" + e + "&status=0"
        });
    },
    isCoupons: function() {
    ...
    sCoupon: function() {
        wx.navigateTo({
            url: "../coupons/coupons?distance=" + this.data.distance + "&money=" + this.data.money
        });
    },
    sPay: function(e) {
